    ...
    <section className={styles.about} id="about__section">
      <div className={styles.about__intro}>
        ...
        <h2 className={styles.about__title}>
          Transforming <span className={styles.about__highlight}>Keys</span> into
          Masterpieces
        </h2>
        ...
        <div className={styles.about__content_top}>
          ...
          <div className={`${styles.about__card} ${styles['about__card--welcome']}`}>
            ...
            <p className={styles.about__desc}>
              ...
              mission is to ensure your instrument sounds its best, whether
              it's a family treasure or a performance-ready masterpiece.
            </p>
            <a className={styles.about__link} href="#">More About →</a>
          </div>
        </div>
        <div className={styles.about__content_bottom}>
          <div className={styles.about__quote}>
            ...
            <p className={styles['about__quote-text']}>
              We are committed to serving the local community with
              professional piano services of exceptional quality. There is no
              piano brand or size difficult for us to handle.
            </p>
